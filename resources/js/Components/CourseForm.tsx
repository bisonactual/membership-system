      ...
      <Grid2 container spacing={3}>
        ...
        <Grid2 size={12}>
          <MarkdownTextField
            ...
            helperText={
              errors.description ||
              'Brief introduction to the induction, what it covers, how the session will be run, etc. Supports markdown formatting.'
            }
            rows={3}
          />
        </Grid2>
        ...
        <Grid2 size={12}>
          <MarkdownTextField
            ...
            helperText={
              ...
              "e.g. 'In-person workshop', 'Online webinar', etc. Supports markdown formatting."
            }
            rows={2}
          />
        </Grid2>
        ...
        <Grid2 size={12}>
          <MarkdownTextField
            ...
            helperText={
              errors.frequency_description ||
              "e.g. 'Weekly on Mondays at 7pm'. Supports markdown formatting."
            }
            rows={2}
          />
        </Grid2>
        ...
        <Grid2 size={12}>
          <MarkdownTextField
            ...
            helperText={
              errors.training_organisation_description ||
              'Instructions to members on how to become trained. E.g. Whether to ask on forum or Telegram, any prerequisites they need to fulfil, etc. Supports markdown formatting.'
            }
            rows={3}
          />
        </Grid2>
        ...
        <Grid2 size={12}>
          <TextField
            ...
            helperText={
              errors.schedule_url ||
              'Link to forum thread, category, or google sheet where training slots are announced (optional)'
            }
          />
        </Grid2>
        ...
        <Grid2 size={12}>
          <TextField
            ...
            helperText={
              errors.request_induction_url ||
              'Link to forum thread for members to request training sessions. We prefer the forum over Telegram, as not every member has or is comfortable using Telegram. (optional)'
            }
          />
        </Grid2>
        ...
        <Grid2 size={12}>
          <FormControl fullWidth error={!!errors.equipment}>
            ...
            <FormHelperText>Select equipment that requires this induction</FormHelperText>
          </FormControl>
        </Grid2>
        ...
        <Grid2 size={12}>
          <FormControlLabel
            control={
              <Switch checked={data.paused} onChange={(e) => setData('paused', e.target.checked)} />
            }
            label="Pause this course"
          />
          {errors.paused && <FormHelperText error>{errors.paused}</FormHelperText>}
        </Grid2>

        <Grid2 size={12}>
          <FormControlLabel
            control={
              <Switch checked={data.live} onChange={(e) => setData('live', e.target.checked)} />
            }
            label="Course is live"
          />
          <FormHelperText>
            When the course is made live, it takes over and becomes the primary way to manage
            inductions for the relevant pieces of equipment. The old induction-related fields on
            equipment pages will no longer be used.
          </FormHelperText>
          {errors.live && <FormHelperText error>{errors.live}</FormHelperText>}
        </Grid2>
