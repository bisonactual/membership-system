...
const Edit = ({ course, equipment, formatOptions, frequencyOptions, urls }: Props) => {
  const { data, setData, put, processing, errors } = useForm({
    ...
    frequency:
      typeof course.data.frequency === 'object'
        ? course.data.frequency.value
        : course.data.frequency,
