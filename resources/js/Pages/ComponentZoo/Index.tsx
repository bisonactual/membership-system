  ...
  return (
    <>
      ...
      <Container maxWidth="lg" sx={{ my: 4 }}>
        ...
        >
          This page showcases various Material UI components with your theme applied. Use this to
          preview how theme changes will affect your UI.
        </Typography>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <Typography variant="body2" color="text.secondary">
                        This is a sample card with some content. Cards can be used for various UI
                        components like dashboard widgets, product displays, etc.
                      </Typography>
                    </CardContent>
                    <CardActions>
...
ComponentZoo.layout = (page: React.ReactNode) => <MainLayout>{page}</MainLayout>;
